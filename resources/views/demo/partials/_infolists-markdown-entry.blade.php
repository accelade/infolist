...
<div class="space-y-8">
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$headingsInfolist" />
        </div>
    </div>
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$listsInfolist" />
        </div>
    </div>
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$codeInfolist" />
        </div>
    </div>
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$tableInfolist" />
        </div>
    </div>
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$blockquoteInfolist" />
        </div>
    </div>
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$scrollInfolist" />
        </div>
    </div>
    ...
    <div class="rounded-xl shadow-sm overflow-hidden" style="background: var(--docs-bg, #ffffff); border: 1px solid var(--docs-border, #e2e8f0);">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$collapsibleInfolist" />
        </div>
    </div>
