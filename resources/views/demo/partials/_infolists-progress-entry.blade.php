...
<div class="space-y-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$autoColorInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$heightsInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$stripedInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$labelsInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$noLabelInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6 pt-0">
            <x-accelade::code-block language="blade">&lt;x-accelade::progress-entry
    label="Download Progress"
    :value="75"
    color="primary"
/&gt;
