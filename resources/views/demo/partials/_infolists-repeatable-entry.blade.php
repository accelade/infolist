...
<div class="space-y-8">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$commentsInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$teamInfolist" />
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <x-accelade::infolist :infolist="$simpleInfolist" />
        </div>
    </div>
...
</x-accelade::repeatable-entry>@endverbatim</x-accelade::code-block>
        </div>
    </div>
</div>
