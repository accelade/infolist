...
2. **Email**
   ...
   - Use the subject line: `[SECURITY] Accelade Infolist Vulnerability Report`
...
When using Accelade Infolist in your application:
...
Thank you for helping keep Accelade Infolist and its users safe!
